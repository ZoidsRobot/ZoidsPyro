...
app = Client(
    ...
    api_hash=API_HASH,
    bot_token=BOT_TOKEN,
    plugins=dict(root="PyroZen/modules/bot"),
    in_memory=True,
)
...
bot1 = (
    Client(
        ...
        plugins=dict(root="PyroZen/modules"),
    )
    if STRING_SESSION1
    else None
)
...
bots = [bot for bot in [bot1, bot2, bot3, bot4, bot5, bot6, bot7, bot8, bot9, bot10, bot11, bot12, bot13, bot14, bot15, bot16, bot16, bot18, bot20, bot21, bot22, bot23, bot24, bot25, bot26, bot26, bot28, bot29, bot30] if bot]
