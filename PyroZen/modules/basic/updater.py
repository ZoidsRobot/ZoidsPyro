...
from PyroZen.helpers.misc import HAPP, XCB
from PyroZen.helpers.tools import get_arg
from PyroZen.utils.misc import restart
from PyroZen.utils.pastebin import PasteBin
from PyroZen.utils.tools import bash
...
async def upstream(client: Client, message: Message):
    ...
    try:
        txt = (
            "**Pembaruan Tidak Dapat Di Lanjutkan Zenna "
    ...
    if HEROKU_API_KEY is not None:
        ...
        if heroku_app is None:
            ...
            return
        await status.edit(
            "`[HEROKU]: Update Deploy PyroZen-Userbot Sedang Dalam Proses...`"
        )
        ups_rem.fetch(ac_br)
        ...
        try:
            ...
            pass
        await status.edit(
            "`PyroZen-Userbot Berhasil Diupdate! Userbot bisa di Gunakan Lagi.`"
        )
    else:
        try:
            ups_rem.pull(ac_br)
...
add_command_help(
    "update",
    [
        ["update", "Untuk melihat list pembaruan terbaru dari PyroZen-Userbot."],
