...
from PyroZen.helpers.data import Data
from PyroZen.helpers.inline import inline_wrapper, paginate_help
from config import BOT_VER, BRANCH as branch
from PyroZen import CMD_HELP, StartTime, app
...
async def Zenman_function(message: Message, answers):
    ...
    answers.append(
        InlineQueryResultArticle(
            ...
            reply_markup=InlineKeyboardMarkup(
                [[InlineKeyboardButton(text="💥sᴜᴘᴘᴏʀᴛ💥", url="t.me/ZennXSupport"), InlineKeyboardButton(text="💢ᴏᴡɴᴇʀ💢", url="t.me/PakkPoll")], [InlineKeyboardButton(text="💢ᴍᴇɴᴜ💢", callback_data="reopen")]]
            ),
        )
    )
    return answers
